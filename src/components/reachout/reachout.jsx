    ...
    return (
        <div className="reachout-comp">
            <div className="r-top" ref={reachoutT}>
                <div className="r-headline">CONTACT MASTERIX HANDYMAN SERVICES</div>
                <h2>Your Home Deserves Master-Level Care — Let’s Talk</h2>
                <p>Whether you’re dreaming of a full remodel, need urgent repairs, or just have a quick question — we’re here to help. At Masterix, you’re not just contacting a handyman; you’re reaching a partner who listens, plans, and delivers</p>
