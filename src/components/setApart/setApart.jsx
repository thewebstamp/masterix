    ...
    return (
        <div className="set-apart-wrap">
            <div className="sa-top" ref={setApartT}>
                <div className="sa-headline">WHY CHOOSE MASTERIX?</div>
                <h2>Experience Craftsmanship You Can Count On</h2>
            ...
            <div className="sa-base" ref={setApartB}>
                ...
                <img src={Images.heroImg3} className="sa-img" />
                <img src={Images.heroImg3} className="sa-img-height" />
            </div>
        </div>
    )
}
